...
**Kernel/Quirks**| Enable `DisableIoMapper` Quirk. Once you've verified that WiFi is working, you can check if WiFi works without this quirk as well. But in my experience on the machines I have, Intel WiFi does not work without it.
